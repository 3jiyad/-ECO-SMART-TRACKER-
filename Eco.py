...
# ==========================================
# --- 4. DIRECT SECTION: ECO ASSESSMENT  (ব্যানারের ঠিক পরেই) ---
# ==========================================
...
# ==========================================
# --- 5. NAVIGATION TABS (OTHER SECTIONS) ---
# ==========================================
...
with tab1:
    ...
    st.success("**Main Objective**\n\nTo establish a modern, live, and user-friendly digital system for environmental tracking and data collection, accessible instantly via cross-device QR code scanning without manual friction.")
...
with tab3:
    ...
    with st.form("score_entry_form", clear_on_submit=True):
        ...
        st.caption("ℹ️ আপনি চাইলে একাধিকবার স্কোর সাবমিট করতে পারবেন।")
    ...
    if os.path.exists(score_file):
        ...
        st.info("No score file created yet.")
...
with tab4:
    ...
    with st.expander("📘 Read Guidelines & Documentation"):
        st.write("This section contains official documentation and sustainability guides.")
